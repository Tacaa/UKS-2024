...
-- TAGS
INSERT INTO tags (name, docker_pull_command, repository_id, pulled, pushed, author) VALUES
('weather-api', 'docker pull api-tools/weather-api', 1, '1 day', '2 days', 'johndoe'),
('forecasting', 'docker pull api-tools/forecasting', 1, '3 days', 'about a week', 'janesmith'),
('weather', 'docker pull api-tools/weather', 1, '2 days', '3 day', 'alicebrown'),
('api-tool', 'docker pull api-tools/api-tool', 1, '3 days', '5 days', 'bobwhite'),
('climate', 'docker pull api-tools/climate', 1, 'about a week', 'about a month', 'charliegreen'),
('cms-builder', 'docker pull content-dev/cms-builder', 2, '1 day', '5 days', 'dianablue'),
('blog-cms', 'docker pull content-dev/blog-cms', 2, '2 days', 'about a week', 'ethanblack'),
('content-management', 'docker pull content-dev/content-management', 2, 'about a month', 'about a month', 'fionagray'),
('cms-core', 'docker pull content-dev/cms-core', 2, '3 days', '5 day', 'georgeyellow'),
('private-cms', 'docker pull content-dev/private-cms', 2, '2 days', '3 days', 'hannahred'),
('blogging-platform', 'docker pull content-dev/blogging-platform', 2, 'about a week', 'about a month', 'ivancarter'),
('content-dev-tool', 'docker pull content-dev/content-dev-tool', 2, '1 day', '2 days', 'jasminefrost'),
('data-analyzer', 'docker pull data-tools/data-analyzer', 3, '2 days', '5 days', 'kevinstone'),
('analytics', 'docker pull data-tools/analytics', 3, '3 days', 'about a week', 'laurahill'),
('data-science', 'docker pull data-tools/data-science', 3, 'about a month', 'about a month', 'michaelocean'),
('data-tools', 'docker pull data-tools/data-tools', 3, '1 day', '2 days', 'ninasky'),
('machine-learning', 'docker pull data-tools/machine-learning', 3, 'about a week', 'about a month', 'oscarwave'),
('ai-analytics', 'docker pull data-tools/ai-analytics', 3, '1 day', 'about a month', 'paulacloud'),
('big-data', 'docker pull data-tools/big-data', 3, '2 days', '5 days', 'quentinrain'),
('secure-storage', 'docker pull db-storage/secure-storage', 4, '3 days', 'about a week', 'ritastorm'),
('database-security', 'docker pull db-storage/database-security', 4, '1 day', '1 day', 'samthunder'),
('encrypted-db', 'docker pull db-storage/encrypted-db', 4, '2 days', '5 days', 'tinalightning'),
('secure-db', 'docker pull db-storage/secure-db', 4, 'about a week', 'about a week', 'umashadow'),
('storage-solutions', 'docker pull db-storage/storage-solutions', 4, '1 day', 'about a month', 'victorflame'),
('private-db', 'docker pull db-storage/private-db', 4, '2 days', '5 days', 'wendyfrost'),
('safe-storage', 'docker pull db-storage/safe-storage', 4, '3 days', 'about a week', 'johndoe'),
('python-framework', 'docker pull lang-lib/python-framework', 5, '1 day', '1 day', 'janesmith'),
('web-framework', 'docker pull lang-lib/web-framework', 5, '2 days', '5 days', 'alicebrown'),
('python-web', 'docker pull lang-lib/python-web', 5, 'about a week', '3 days', 'bobwhite'),
('backend-framework', 'docker pull lang-lib/backend-framework', 5, '1 day', 'about a month', 'charliegreen'),
('language-library', 'docker pull lang-lib/language-library', 5, '2 days', '5 days', 'dianablue'),
('fast-python', 'docker pull lang-lib/fast-python', 5, '3 days', 'about a week', 'ethanblack'),
('framework-tools', 'docker pull lang-lib/framework-tools', 5, 'about a month', 'about a month', 'fionagray'),
('iot-platform', 'docker pull iot-dev/iot-platform', 6, '3 days', '5 days', 'georgeyellow'),
('smart-devices', 'docker pull iot-dev/smart-devices', 6, 'about a week', 'about a week', 'hannahred'),
('iot-dev', 'docker pull iot-dev/iot-dev', 6, '1 day', 'about a month', 'ivancarter'),
('device-management', 'docker pull iot-dev/device-management', 6, '2 days', '5 days', 'jasminefrost'),
('iot-solutions', 'docker pull iot-dev/iot-solutions', 6, '3 days', 'about a week', 'kevinstone'),
('connected-devices', 'docker pull iot-dev/connected-devices', 6, 'about a month', 'about a month', 'laurahill'),
('iot-tools', 'docker pull iot-dev/iot-tools', 6, '2 days', '5 days', 'michaelocean'),
('ml-toolkit', 'docker pull ai-tools/ml-toolkit', 7, 'about a week', 'about a week', 'ninasky'),
('ai-development', 'docker pull ai-tools/ai-development', 7, '1 day', 'about a month', 'oscarwave'),
('ml-library', 'docker pull ai-tools/ml-library', 7, '2 days', '5 days', 'paulacloud'),
('ai-tools', 'docker pull ai-tools/ai-tools', 7, '3 days', 'about a week', 'quentinrain'),
('deep-learning', 'docker pull ai-tools/deep-learning', 7, '1 day', '1 day', 'ritastorm'),
('ai-solutions', 'docker pull ai-tools/ai-solutions', 7, '2 days', '5 days', 'samthunder'),
('ml-development', 'docker pull ai-tools/ml-development', 7, '3 days', 'about a week', 'tinalightning'),
('cloud-storage', 'docker pull cloud-solutions/cloud-storage', 8, '1 day', 'about a month', 'umashadow'),
('enterprise-storage', 'docker pull cloud-solutions/enterprise-storage', 8, '2 days', '5 days', 'victorflame'),
('db-storage', 'docker pull cloud-solutions/db-storage', 8, '3 days', 'about a week', 'wendyfrost'),
('secure-cloud', 'docker pull cloud-solutions/secure-cloud', 8, '1 day', '1 day', 'johndoe'),
('cloud-solutions', 'docker pull cloud-solutions/cloud-solutions', 8, '2 days', '3 days', 'janesmith'),
('data-storage', 'docker pull cloud-solutions/data-storage', 8, '2 days', '3 days', 'alicebrown'),
('backup-solutions', 'docker pull cloud-solutions/backup-solutions', 8, '1 day', 'about a month', 'bobwhite'),
('devops-pipeline', 'docker pull devops-tools/devops-pipeline', 9, '2 days', '5 days', 'charliegreen'),
('ci-cd', 'docker pull devops-tools/ci-cd', 9, '3 days', 'about a week', 'dianablue'),
('automation-tools', 'docker pull devops-tools/automation-tools', 9, '3 days', 'about a week', 'ethanblack'),
('deployment-pipeline', 'docker pull devops-tools/deployment-pipeline', 9, '2 days', '5 days', 'fionagray'),
('devops-tools', 'docker pull devops-tools/devops-tools', 9, '2 days', '5 days', 'georgeyellow'),
('continuous-delivery', 'docker pull devops-tools/continuous-delivery', 9, '1 day', 'about a month', 'hannahred'),
('integration-tools', 'docker pull devops-tools/integration-tools', 9, '2 days', '5 days', 'ivancarter'),
('web-server-framework', 'docker pull web-server/web-server-framework', 10, '3 days', 'about a week', 'jasminefrost'),
('web-server', 'docker pull web-server/web-server', 10, '2 days', '5 days', 'kevinstone'),
('deployment-tools', 'docker pull web-server/deployment-tools', 10, '2 days', '3 days', 'laurahill'),
('fast-deployment', 'docker pull web-server/fast-deployment', 10, '3 days', 'about a week', 'michaelocean'),
('server-framework', 'docker pull web-server/server-framework', 10, '1 day', 'about a month', 'ninasky'),
('scalable-server', 'docker pull web-server/scalable-server', 10, '2 days', '5 days', 'oscarwave'),
('web-app-tools', 'docker pull web-server/web-app-tools', 10, '3 days', 'about a week', 'paulacloud'),
('data-pipeline', 'docker pull data-processing/data-pipeline', 11, '1 day', 'about a month', 'quentinrain'),
('large-dataset-tools', 'docker pull data-processing/large-dataset-tools', 11, '2 days', '2 days', 'ritastorm'),
('data-processing', 'docker pull data-processing/data-processing', 11, '3 days', 'about a week', 'samthunder'),
('security-toolkit', 'docker pull security-tools/security-toolkit', 12, '1 day', 'about a month', 'tinalightning'),
('sysadmin-tools', 'docker pull security-tools/sysadmin-tools', 12, '2 days', '5 days', 'umashadow'),
('system-security', 'docker pull security-tools/system-security', 12, '3 days', 'about a week', 'victorflame'),
('messaging-queue', 'docker pull message-queues/messaging-queue', 13, '1 day', 'about a month', 'wendyfrost'),
('microservices-communication', 'docker pull message-queues/microservices-communication', 13, '2 days', '2 days', 'johndoe'),
('message-queues', 'docker pull message-queues/message-queues', 13, '3 days', 'about a week', 'janesmith'),
('mentoring-platform', 'docker pull mentoring-tools/mentoring-platform', 14, '1 day', 'about a month', 'alicebrown'),
('developer-tools2', 'docker pull mentoring-tools/developer-tools', 14, '2 days', '5 days', 'bobwhite'),
('mentoring-tools', 'docker pull mentoring-tools/mentoring-tools', 14, '3 days', 'about a week', 'charliegreen'),
('networking-tools', 'docker pull networking-dev/networking-tools', 15, '3 days', 'about a month', 'dianablue'),
('large-scale-networks', 'docker pull networking-dev/large-scale-networks', 15, '5 days', '5 days', 'ethanblack'),
('networking-dev', 'docker pull networking-dev/networking-dev', 15, '3 days', 'about a week', 'fionagray'),
('os-library', 'docker pull os-tools/os-library', 16, '1 day', 'about a month', 'georgeyellow'),
('os-utilities', 'docker pull os-tools/os-utilities', 16, '2 days', '5 days', 'hannahred'),
('os-tools', 'docker pull os-tools/os-tools', 16, '3 days', 'about a week', 'ivancarter'),
('observability-tools', 'docker pull observability/observability-tools', 17, '3 days', 'about a month', 'jasminefrost'),
('monitoring-tools', 'docker pull observability/monitoring-tools', 17, '2 days', '2 days', 'kevinstone'),
('observability', 'docker pull observability/observability', 17, '3 days', 'about a week', 'laurahill'),
('secure-api', 'docker pull api-security/secure-api', 18, '1 day', 'about a month', 'michaelocean'),
('api-authentication', 'docker pull api-security/api-authentication', 18, '2 days', '5 days', 'ninasky'),
('api-security', 'docker pull api-security/api-security', 18, '3 days', 'about a week', 'oscarwave'),
('docker-extension', 'docker pull docker-tools/docker-extension', 19, '1 day', 'about a month', 'paulacloud'),
('docker-enhancements', 'docker pull docker-tools/docker-enhancements', 19, '2 days', '2 days', 'quentinrain'),
('docker-tools', 'docker pull docker-tools/docker-tools', 19, '3 days', 'about a week', 'ritastorm'),
('cloud-api', 'docker pull cloud-tools/cloud-api', 20, '1 day', 'about a month', 'samthunder'),
('cloud-integration', 'docker pull cloud-tools/cloud-integration', 20, '2 days', '5 days', 'tinalightning'),
('cloud-tools', 'docker pull cloud-tools/cloud-tools', 20, '3 days', 'about a week', 'umashadow'),
('modern-web-apps', 'docker pull web-dev/modern-web-apps', 21, 'about a week', 'about a month', 'victorflame'),
('frontend-framework', 'docker pull web-dev/frontend-framework', 21, '1 day', '2 days', 'wendyfrost'),
('python-tools', 'docker pull python-utils/python-tools', 22, 'about a week', 'about a week', 'johndoe'),
('developer-tools3', 'docker pull python-utils/developer-tools3', 22, '1 day', 'about a month', 'janesmith'),
('java-library', 'docker pull java-lib/java-library', 23, '2 days', '5 days', 'alicebrown'),
('backend-tools', 'docker pull java-lib/backend-tools', 23, '3 days', 'about a week', 'bobwhite'),
('db-tools', 'docker pull db-dev/db-tools', 24, 'about a week', 'about a month', 'charliegreen'),
('database-management', 'docker pull db-dev/database-management', 24, '1 day', '2 days', 'dianablue'),
('ai-platform', 'docker pull ai-development/ai-platform', 25, 'about a week', 'about a week', 'ethanblack'),
('ml-development2', 'docker pull ai-development/ml-development2', 25, '1 day', 'about a month', 'fionagray'),
('automated-backups', 'docker pull backup-dev/automated-backups', 26, '2 days', '5 days', 'georgeyellow'),
('backup-tools', 'docker pull backup-dev/backup-tools', 26, '3 days', 'about a week', 'hannahred'),
('real-time-data', 'docker pull realtime-data/real-time-data', 27, 'about a month', 'about a month', 'ivancarter'),
('data-analytics', 'docker pull realtime-data/data-analytics', 27, '2 days', '5 days', 'jasminefrost'),
('web-crawling', 'docker pull web-tools/web-crawling', 28, 'about a week', 'about a month', 'kevinstone'),
('data-scraping', 'docker pull web-tools/data-scraping', 28, '1 day', 'about a month', 'laurahill'),
('database-backups', 'docker pull db-tools/database-backups', 29, '2 days', '5 days', 'michaelocean'),
('backup-solutions2', 'docker pull db-tools/backup-solutions2', 29, '3 days', 'about a week', 'ninasky'),
('virtualization-tools', 'docker pull virtualization-dev/virtualization-tools', 30, 'about a month', 'about a month', 'oscarwave'),
('virtualized-environments', 'docker pull virtualization-dev/virtualized-environments', 30, '1 day', '2 days', 'paulacloud'),
('websockets2', 'docker pull web-server/websockets2', 31, 'about a week', 'about a month', 'quentinrain'),
('web-server-framework2', 'docker pull web-server/web-server-framework2', 31, '1 day', 'about a month', 'ritastorm'),
('auth-service', 'docker pull auth-service/auth-service', 32, '2 days', '5 days', 'samthunder'),
('user-authentication', 'docker pull auth-service/user-authentication', 32, '3 days', 'about a week', 'tinalightning'),
('server-management', 'docker pull server-admin/server-management', 33, 'about a month', 'about a month', 'umashadow'),
('monitoring-tools2', 'docker pull server-admin/monitoring-tools2', 33, '1 day', '3 days', 'victorflame'),
('data-warehouse', 'docker pull big-data/data-warehouse', 34, '3 days', 'about a week', 'wendyfrost'),
('big-data-tools', 'docker pull big-data/big-data-tools', 34, '1 day', 'about a month', 'johndoe'),
('file-compression', 'docker pull file-utils/file-compression', 35, '2 days', '5 days', 'janesmith'),
('archive-tools', 'docker pull file-utils/archive-tools', 35, '3 days', 'about a week', 'alicebrown'),
('task-scheduler', 'docker pull task-management/task-scheduler', 36, 'about a month', 'about a month', 'bobwhite'),
('automation-tools4', 'docker pull task-management/automation-tools4', 36, '1 day', '2 days', 'charliegreen'),
('api-integration', 'docker pull api-tools/api-integration', 37, 'about a month', 'about a month', 'dianablue'),
('external-systems', 'docker pull api-tools/external-systems', 37, '1 day', 'about a month', 'ethanblack'),
('test-automation', 'docker pull automation-tools/test-automation', 38, '2 days', '5 days', 'fionagray'),
('quality-assurance', 'docker pull automation-tools/quality-assurance', 38, '3 days', 'about a week', 'georgeyellow'),
('system-monitoring', 'docker pull system-admin/system-monitoring', 39, 'about a month', 'about a month', 'hannahred'),
('performance-tools', 'docker pull system-admin/performance-tools', 39, '2 days', '2 days', 'ivancarter'),
('api-proxy', 'docker pull api-gateway/api-proxy', 40, 'about a month', 'about a month', 'jasminefrost'),
('request-routing', 'docker pull api-gateway/request-routing', 40, '1 day', 'about a month', 'kevinstone');