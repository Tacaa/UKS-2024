...
('weather', 'docker pull api-tools/weather', 1, '2 days', '1 day', 'alicebrown'),
('api-tool', 'docker pull api-tools/api-tool', 1, '5 days', '3 days', 'bobwhite'),
...
('content-management', 'docker pull content-dev/content-management', 2, 'about a month', '2 days', 'fionagray'),
('cms-core', 'docker pull content-dev/cms-core', 2, '3 days', '1 day', 'georgeyellow'),
('private-cms', 'docker pull content-dev/private-cms', 2, '5 days', '3 days', 'hannahred'),
...
('data-science', 'docker pull data-tools/data-science', 3, 'about a month', '1 day', 'michaelocean'),
('data-tools', 'docker pull data-tools/data-tools', 3, '5 days', '2 days', 'ninasky'),
('machine-learning', 'docker pull data-tools/machine-learning', 3, 'about a week', '3 days', 'oscarwave'),
...
('database-security', 'docker pull db-storage/database-security', 4, 'about a month', '1 day', 'samthunder'),
('encrypted-db', 'docker pull db-storage/encrypted-db', 4, '5 days', '2 days', 'tinalightning'),
('secure-db', 'docker pull db-storage/secure-db', 4, 'about a week', '3 days', 'umashadow'),
...
('python-framework', 'docker pull lang-lib/python-framework', 5, 'about a month', '1 day', 'janesmith'),
('web-framework', 'docker pull lang-lib/web-framework', 5, '5 days', '2 days', 'alicebrown'),
...
('framework-tools', 'docker pull lang-lib/framework-tools', 5, 'about a month', '1 day', 'fionagray'),
('iot-platform', 'docker pull iot-dev/iot-platform', 6, '5 days', '2 days', 'georgeyellow'),
('smart-devices', 'docker pull iot-dev/smart-devices', 6, 'about a week', '3 days', 'hannahred'),
...
('connected-devices', 'docker pull iot-dev/connected-devices', 6, 'about a month', '1 day', 'laurahill'),
('iot-tools', 'docker pull iot-dev/iot-tools', 6, '5 days', '2 days', 'michaelocean'),
('ml-toolkit', 'docker pull ai-tools/ml-toolkit', 7, 'about a week', '3 days', 'ninasky'),
...
('deep-learning', 'docker pull ai-tools/deep-learning', 7, 'about a month', '1 day', 'ritastorm'),
('ai-solutions', 'docker pull ai-tools/ai-solutions', 7, '5 days', '2 days', 'samthunder'),
('ml-development', 'docker pull ai-tools/ml-development', 7, 'about a week', '3 days', 'tinalightning'),
...
('secure-cloud', 'docker pull cloud-solutions/secure-cloud', 8, 'about a month', '1 day', 'johndoe'),
('cloud-solutions', 'docker pull cloud-solutions/cloud-solutions', 8, '5 days', '2 days', 'janesmith'),
('data-storage', 'docker pull cloud-solutions/data-storage', 8, 'about a week', '3 days', 'alicebrown'),
...
('automation-tools', 'docker pull devops-tools/automation-tools', 9, 'about a month', '1 day', 'ethanblack'),
('deployment-pipeline', 'docker pull devops-tools/deployment-pipeline', 9, '5 days', '2 days', 'fionagray'),
('devops-tools', 'docker pull devops-tools/devops-tools', 9, 'about a week', '3 days', 'georgeyellow'),
...
('web-server', 'docker pull web-server/web-server', 10, 'about a month', '1 day', 'kevinstone'),
('deployment-tools', 'docker pull web-server/deployment-tools', 10, '5 days', '2 days', 'laurahill'),
('fast-deployment', 'docker pull web-server/fast-deployment', 10, 'about a week', '3 days', 'michaelocean'),
...
('data-pipeline', 'docker pull data-processing/data-pipeline', 11, 'about a month', '1 day', 'quentinrain'),
('large-dataset-tools', 'docker pull data-processing/large-dataset-tools', 11, '5 days', '2 days', 'ritastorm'),
('data-processing', 'docker pull data-processing/data-processing', 11, 'about a week', '3 days', 'samthunder'),
...
('messaging-queue', 'docker pull message-queues/messaging-queue', 13, 'about a month', '1 day', 'wendyfrost'),
('microservices-communication', 'docker pull message-queues/microservices-communication', 13, '5 days', '2 days', 'johndoe'),
('message-queues', 'docker pull message-queues/message-queues', 13, 'about a week', '3 days', 'janesmith'),
...
('networking-tools', 'docker pull networking-dev/networking-tools', 15, 'about a month', '1 day', 'dianablue'),
('large-scale-networks', 'docker pull networking-dev/large-scale-networks', 15, '5 days', '2 days', 'ethanblack'),
('networking-dev', 'docker pull networking-dev/networking-dev', 15, 'about a week', '3 days', 'fionagray'),
...
('observability-tools', 'docker pull observability/observability-tools', 17, 'about a month', '1 day', 'jasminefrost'),
('monitoring-tools', 'docker pull observability/monitoring-tools', 17, '5 days', '2 days', 'kevinstone'),
('observability', 'docker pull observability/observability', 17, 'about a week', '3 days', 'laurahill'),
...
('docker-extension', 'docker pull docker-tools/docker-extension', 19, 'about a month', '1 day', 'paulacloud'),
('docker-enhancements', 'docker pull docker-tools/docker-enhancements', 19, '5 days', '2 days', 'quentinrain'),
('docker-tools', 'docker pull docker-tools/docker-tools', 19, 'about a week', '3 days', 'ritastorm'),
...
('modern-web-apps', 'docker pull web-dev/modern-web-apps', 21, 'about a month', '1 day', 'victorflame'),
('frontend-framework', 'docker pull web-dev/frontend-framework', 21, '5 days', '2 days', 'wendyfrost'),
('python-tools', 'docker pull python-utils/python-tools', 22, 'about a week', '3 days', 'johndoe'),
...
('db-tools', 'docker pull db-dev/db-tools', 24, 'about a month', '1 day', 'charliegreen'),
('database-management', 'docker pull db-dev/database-management', 24, '5 days', '2 days', 'dianablue'),
('ai-platform', 'docker pull ai-development/ai-platform', 25, 'about a week', '3 days', 'ethanblack'),
...
('real-time-data', 'docker pull realtime-data/real-time-data', 27, 'about a month', '1 day', 'ivancarter'),
('data-analytics', 'docker pull realtime-data/data-analytics', 27, '5 days', '2 days', 'jasminefrost'),
('web-crawling', 'docker pull web-tools/web-crawling', 28, 'about a week', '3 days', 'kevinstone'),
...
('virtualization-tools', 'docker pull virtualization-dev/virtualization-tools', 30, 'about a month', '1 day', 'oscarwave'),
('virtualized-environments', 'docker pull virtualization-dev/virtualized-environments', 30, '5 days', '2 days', 'paulacloud'),
('websockets2', 'docker pull web-server/websockets2', 31, 'about a week', '3 days', 'quentinrain'),
...
('server-management', 'docker pull server-admin/server-management', 33, 'about a month', '1 day', 'umashadow'),
('monitoring-tools2', 'docker pull server-admin/monitoring-tools2', 33, '5 days', '2 days', 'victorflame'),
('data-warehouse', 'docker pull big-data/data-warehouse', 34, 'about a week', '3 days', 'wendyfrost'),
...
('task-scheduler', 'docker pull task-management/task-scheduler', 36, 'about a month', '1 day', 'bobwhite'),
('automation-tools4', 'docker pull task-management/automation-tools4', 36, '5 days', '2 days', 'charliegreen'),
('api-integration', 'docker pull api-tools/api-integration', 37, 'about a week', '3 days', 'dianablue'),
...
('system-monitoring', 'docker pull system-admin/system-monitoring', 39, 'about a month', '1 day', 'hannahred'),
('performance-tools', 'docker pull system-admin/performance-tools', 39, '5 days', '2 days', 'ivancarter'),
('api-proxy', 'docker pull api-gateway/api-proxy', 40, 'about a week', '3 days', 'jasminefrost'),
