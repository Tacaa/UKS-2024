...
-- REPOSITORIES
INSERT INTO repositories (id, name, namespace, description, visibility, created, updated, star, personal, category, owner_id, type, prefix, badge, organisation_id) VALUES
(1, 'WeatherAPI', 'api-tools', 'Weather forecasting API tool', 'PUBLIC', '2024-12-01 10:00:00', '2024-12-01 12:00:00', 85, true, 'API_MANAGMENT', 1, 'Repository', NULL, 'NONE', 1),
(2, 'CMSBuilder', 'content-dev', 'Content management system for blogs', 'PRIVATE', '2024-12-02 14:00:00', '2024-12-02 15:30:00', 42, false, 'CONTENT_MANAGMENT_SYSTEM', 2, 'Official', 'OFF-001', 'DOCKER_OFFICIAL_IMAGE', 2),
(3, 'DataAnalyzer', 'data-tools', 'Data science library for analytics', 'PUBLIC', '2024-12-03 08:30:00', '2024-12-03 09:45:00', 110, true, 'DATA_SCIENCE', 3, 'Repository', NULL, 'NONE', 3),
(4, 'SecureStorage', 'db-storage', 'Secure database storage solutions', 'PRIVATE', '2024-12-04 09:00:00', '2024-12-04 11:20:00', 78, false, 'DATABASE_AND_STORAGE', 5, 'Official', 'OFF-002', 'DOCKER_OFFICIAL_IMAGE', 4),
(5, 'PythonFramework', 'lang-lib', 'Python framework for web apps', 'PUBLIC', '2024-12-05 13:45:00', '2024-12-05 14:15:00', 200, true, 'LANGUAGE_AND_FRAMEWORKS', 5, 'Repository', NULL, 'NONE', 4),
(6, 'IoTPlatform', 'iot-dev', 'IoT platform for smart devices', 'PRIVATE', '2024-12-06 07:00:00', '2024-12-06 08:10:00', 54, false, 'INTERNET_OF_THINGS', 6, 'Official', 'OFF-003', 'DOCKER_OFFICIAL_IMAGE', 5),
(7, 'MLToolkit', 'ai-tools', 'Machine learning toolkit for developers', 'PUBLIC', '2024-12-07 09:30:00', '2024-12-07 10:45:00', 130, true, 'MACHINE_LEARNING_AND_AI', 7, 'Repository', NULL, 'NONE', null),
(8, 'CloudStorage', 'cloud-solutions', 'Cloud storage solutions for enterprises', 'PRIVATE', '2024-12-08 12:15:00', '2024-12-08 14:00:00', 95, false, 'DATABASE_AND_STORAGE', 8, 'Official', 'OFF-004', 'DOCKER_OFFICIAL_IMAGE', 6),
(9, 'DevOpsPipeline', 'devops-tools', 'Continuous integration and deployment pipeline', 'PUBLIC', '2024-12-09 15:00:00', '2024-12-09 16:30:00', 88, true, 'DEVOPS', 8, 'Repository', NULL, 'NONE', 6),
(10, 'WebServerFramework', 'web-server', 'Web server framework for fast deployments', 'PRIVATE', '2024-12-10 11:30:00', '2024-12-10 13:00:00', 210, true, 'WEB_SERVERS', 8, 'Official', 'OFF-005', 'DOCKER_OFFICIAL_IMAGE', 1),
(11, 'DataPipeline', 'data-processing', 'Data pipeline tools for processing large datasets', 'PUBLIC', '2024-12-11 14:30:00', '2024-12-11 15:45:00', 115, false, 'INTEGRATION_AND_DELIVERY', 11, 'Repository', NULL, 'NONE', 1),
(12, 'SecurityToolkit', 'security-tools', 'Security tools for system administrators', 'PRIVATE', '2024-12-12 16:45:00', '2024-12-12 18:00:00', 67, false, 'SECURITY', 12, 'Official', 'OFF-006', 'DOCKER_OFFICIAL_IMAGE', 2),
(13, 'MessagingQueue', 'message-queues', 'Message queues for microservice communication', 'PUBLIC', '2024-12-13 10:00:00', '2024-12-13 11:20:00', 150, true, 'MESSAGE_QUEUES', 13, 'Repository', NULL, 'NONE', 3),
(14, 'MentoringPlatform', 'mentoring-tools', 'Online mentoring platform for developers', 'PRIVATE', '2024-12-14 13:30:00', '2024-12-14 14:40:00', 102, false, 'MENTORING_AND_OBSERVABILITY', 14, 'Official', 'OFF-007', 'DOCKER_OFFICIAL_IMAGE', null),
(15, 'NetworkingTools', 'networking-dev', 'Networking tools for large-scale networks', 'PUBLIC', '2024-12-15 09:45:00', '2024-12-15 11:00:00', 80, true, 'NETWORKING', 15, 'Repository', NULL, 'NONE', 6),
(16, 'OSLibrary', 'os-tools', 'Operating system utilities for developers', 'PRIVATE', '2024-12-16 14:00:00', '2024-12-16 15:10:00', 50, false, 'OPERATING_SYSTEM', 16, 'Official', 'OFF-008', 'DOCKER_OFFICIAL_IMAGE', 8),
(17, 'ObservabilityTools', 'observability', 'Tools for monitoring and observability', 'PUBLIC', '2024-12-17 12:30:00', '2024-12-17 14:10:00', 120, true, 'OBSERVABILITY', 17, 'Repository', NULL, 'NONE', 9),
(18, 'SecureAPI', 'api-security', 'Secure API authentication and authorization', 'PRIVATE', '2024-12-18 08:15:00', '2024-12-18 09:30:00', 95, false, 'SECURITY', 18, 'Official', 'OFF-009', 'DOCKER_OFFICIAL_IMAGE', 10),
(19, 'DockerExtension', 'docker-tools', 'Extensions for enhancing Docker workflows', 'PUBLIC', '2024-12-19 11:00:00', '2024-12-19 12:45:00', 130, true, 'DOCKER_EXTENSIONS', 18, 'Repository', NULL, 'NONE', 11),
(20, 'CloudAPI', 'cloud-tools', 'API for integrating with cloud services', 'PRIVATE', '2024-12-20 09:30:00', '2024-12-20 10:45:00', 200, true, 'API_MANAGMENT', 18, 'Official', 'OFF-010', 'DOCKER_OFFICIAL_IMAGE', 12),
(21, 'FrontendFramework', 'web-dev', 'Frontend framework for modern web apps', 'PUBLIC', '2024-12-21 14:00:00', '2024-12-21 15:30:00', 180, true, 'FRONTEND', 21, 'Repository', NULL, 'NONE', 13),
(22, 'PythonTools', 'python-utils', 'Tools for Python developers', 'PRIVATE', '2024-12-22 13:30:00', '2024-12-22 14:55:00', 110, false, 'LANGUAGE_AND_FRAMEWORKS', 22, 'Official', 'OFF-011', 'DOCKER_OFFICIAL_IMAGE', 14),
(23, 'JavaFramework', 'java-lib', 'Java library for backend apps', 'PUBLIC', '2024-12-23 12:00:00', '2024-12-23 13:25:00', 95, true, 'LANGUAGE_AND_FRAMEWORKS', 23, 'Repository', NULL, 'NONE', 15),
(24, 'DatabaseTools', 'db-dev', 'Tools for managing databases', 'PRIVATE', '2024-12-24 09:45:00', '2024-12-24 11:10:00', 130, false, 'DATABASE_AND_STORAGE', 24, 'Official', 'OFF-012', 'DOCKER_OFFICIAL_IMAGE', 16),
(25, 'AIPlatform', 'ai-development', 'Platform for building AI models', 'PUBLIC', '2024-12-25 10:00:00', '2024-12-25 11:30:00', 150, true, 'MACHINE_LEARNING_AND_AI', 25, 'Repository', NULL, 'NONE', 17),
(26, 'BackupTools', 'backup-dev', 'Tools for automated backups', 'PRIVATE', '2024-12-26 08:15:00', '2024-12-26 09:40:00', 50, false, 'DATABASE_AND_STORAGE', 1, 'Official', 'OFF-013', 'DOCKER_OFFICIAL_IMAGE', 18),
(27, 'RealTimeAnalytics', 'realtime-data', 'Real-time data processing and analytics', 'PUBLIC', '2024-12-27 14:30:00', '2024-12-27 15:55:00', 120, true, 'DATA_SCIENCE', 1, 'Repository', NULL, 'NONE', 19),
(28, 'WebCrawler', 'web-tools', 'Web crawler for data scraping', 'PRIVATE', '2024-12-28 11:00:00', '2024-12-28 12:15:00', 70, false, 'DEVOPS', 2, 'Official', 'OFF-014', 'DOCKER_OFFICIAL_IMAGE', 20),
(29, 'DatabaseBackup', 'db-tools', 'Backup solutions for databases', 'PUBLIC', '2024-12-29 09:30:00', '2024-12-29 11:05:00', 65, true, 'DATABASE_AND_STORAGE', 2, 'Repository', NULL, 'NONE', null),
(30, 'VirtualizationTools', 'virtualization-dev', 'Tools for virtualized environments', 'PRIVATE', '2024-12-30 10:00:00', '2024-12-30 11:25:00', 90, false, 'DATABASE_AND_STORAGE', 3, 'Official', 'OFF-015', 'DOCKER_OFFICIAL_IMAGE', null),
(31, 'WebSocketServer', 'web-server', 'WebSocket server implementation for apps', 'PUBLIC', '2024-12-31 13:30:00', '2024-12-31 14:40:00', 150, true, 'WEB_SERVERS',3, 'Repository', NULL, 'NONE', 10),
(32, 'AuthenticationService', 'auth-service', 'Service for handling user authentication', 'PRIVATE', '2024-11-01 08:45:00', '2024-11-01 10:05:00', 55, false, 'SECURITY', 3, 'Official', 'OFF-016', 'DOCKER_OFFICIAL_IMAGE', 9),
(33, 'ServerManagement', 'server-admin', 'Tools for server management and monitoring', 'PUBLIC', '2024-11-02 10:15:00', '2024-11-02 11:25:00', 100, true, 'SECURITY', 5, 'Repository', NULL, 'NONE', 8),
(34, 'DataWarehouse', 'big-data', 'Warehouse for storing large datasets', 'PRIVATE', '2024-11-03 09:00:00', '2024-11-03 10:30:00', 130, false, 'DATA_SCIENCE', 5, 'Official', 'OFF-017', 'DOCKER_OFFICIAL_IMAGE', 7),
(35, 'FileCompression', 'file-utils', 'Tools for compressing files and archives', 'PUBLIC', '2024-11-04 10:40:00', '2024-11-04 12:10:00', 40, true, 'OPERATING_SYSTEM', 6, 'Repository', NULL, 'NONE', 6),
(36, 'TaskScheduler', 'task-management', 'Task scheduling and automation system', 'PRIVATE', '2024-11-05 08:00:00', '2024-11-05 09:15:00', 98, false, 'OPERATING_SYSTEM', 6, 'Official', 'OFF-018', 'DOCKER_OFFICIAL_IMAGE', 5),
(37, 'APIIntegration', 'api-tools', 'API integration for external systems', 'PUBLIC', '2024-11-06 13:30:00', '2024-11-06 14:45:00', 160, true, 'API_MANAGMENT', 7, 'Repository', NULL, 'NONE', null),
(38, 'TestAutomation', 'automation-tools', 'Automated testing tools for apps', 'PRIVATE', '2024-11-07 09:45:00', '2024-11-07 11:00:00', 120, false, 'OPERATING_SYSTEM', 7, 'Official', 'OFF-019', 'DOCKER_OFFICIAL_IMAGE', null),
(39, 'SystemMonitoring', 'system-admin', 'Tools for system and performance monitoring', 'PUBLIC', '2024-11-08 08:10:00', '2024-11-08 09:20:00', 80, true, 'OPERATING_SYSTEM', 8, 'Repository', NULL, 'NONE', null),
(40, 'APIProxy', 'api-gateway', 'API gateway for routing requests', 'PRIVATE', '2024-11-09 10:30:00', '2024-11-09 11:40:00', 70, false, 'API_MANAGMENT', 8, 'Official', 'OFF-020', 'DOCKER_OFFICIAL_IMAGE', null);
